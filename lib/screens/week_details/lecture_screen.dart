            ...
            flexibleSpace: Stack(
              children: [
                      ...
                      child: Padding(
                        ...
                        child: Row(
                            ...
                            children: [
                              ...
                              ...List.generate(weekDetails.length,
                                (index) =>Expanded(child: tabBuilder(index, cubit, context)) )
                            ]
                        ),
                      ),
                    ),
                ...
                Positioned(
                  ...
                  right: context.locale==const Locale('en')?null:size.width*0.015,
                  left:context.locale==const Locale('en')? size.width*0.015:null,
                  child: CircleAvatar(
...
@override
  void dispose() {
cubit.locked=[false,false,false,true,true];
    super.dispose();
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                CircleAvatar(
                  radius: 19,
                  backgroundColor: cubit.weekTemplateCurrentIndex == index?const Color(0XFF9C3A44):ColorsManger.appbarColor,
                  child: CircleAvatar(
                    backgroundColor: (cubit.weekTemplateCurrentIndex == index)?const Color(0XFF9C3A44):Colors.white,
                    radius: 18,
                    child: Center(child:
                    Icon(weekDetails[index]['image'],color: cubit.weekTemplateCurrentIndex == index?Colors.white:ColorsManger.appbarColor,)),
                  ),
                ),
                const SizedBox(
                  height: 5,
